...
Item {
    ...
    ShaderEffectSource {
        ...
        live: true
        hideSource: visible
        smooth: control.radius > 0
    }
    property string __internalBlurVertexShader: "qrc:/qt/qml/FluentUI/Controls/shaders/fastblur_internal.vert.qsb"
    property string __internalBlurFragmentShader: "qrc:/qt/qml/FluentUI/Controls/shaders/fastblur_internal.frag.qsb"
    ShaderEffect {
        id: level0
    ...
    ShaderEffect {
        ...
        property real lod: Math.sqrt(control.radius / 64.0) * 1.2 - 0.2
        ...
        fragmentShader: "qrc:/qt/qml/FluentUI/Controls/shaders/fastblur.frag.qsb"
    }
}
