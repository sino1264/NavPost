...
Item {
    ...
    function createTab(key,icon,text,page,argument={}){
        return {key:key,icon:icon,text:text,page:page,argument:argument}
    }
    function appendTab(key,icon,text,page,argument){
        tab_model.append(createTab(key,icon,text,page,argument))
    }
