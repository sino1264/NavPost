...
Item{
    ...
    Dialog {
        ...
        onAccepted:{
            ...
            var item={
                ...
                station_type:root.is_dynamic?DefStationType.Dynamic:DefStationType.Static,
    ...
    //导入文件配置的Dialog  用来配置导入文件的详细选项
    Dialog {
        id: coordConvertDialog
        x: Math.ceil((parent.width - width) / 2)
        y: Math.ceil((parent.height - height) / 2)
        width: 420//Math.ceil(parent.width / 2)
        // contentHeight: 400
        parent: Overlay.overlay
        modal: true
        title: qsTr("配置站点坐标")
                    ...
                    Frame{
                        ...
                        Column{
                            ...
                            Row{
                                spacing:10
                                Label{
                                    text:qsTr("高程/Z：") //Ellipsoidal Height
                                    width:90
                                    anchors.verticalCenter:parent.verticalCenter
                                }
                                TextBox{
